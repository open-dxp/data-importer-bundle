...
use OpenDxp\Model\DataObject\Data\InputQuantityValue as ModelInputQuantityValue;
...
{
    /**
     * @var \OpenDxp\Bundle\DataImporterBundle\Tests\UnitTester
     */
    protected $tester;
    ...
    public function testQuantityValue() {
        ...
        /**
         * @var \OpenDxp\Bundle\DataImporterBundle\Mapping\Operator\Factory\QuantityValue $quantityValue
         */
        $quantityValue = $this->tester->grabService(\OpenDxp\Bundle\DataImporterBundle\Mapping\Operator\Factory\QuantityValue::class);
    ...
    public function testInputQuantityArray()
    {
        ...
        /**
          * @var \OpenDxp\Model\DataObject\Data\InputQuantityValue $result
        */
        $result = $operator->process([['12', 'm']]);
        $this->assertInstanceOf(\OpenDxp\Model\DataObject\Data\InputQuantityValue::class, $result[0]);
        $this->assertEquals('12', $result[0]->getValue());
        $this->assertEquals('m', $result[0]->getUnitId());
        $this->assertEquals('Meter', $result[0]->getUnit()->getLongname());
