...
{
    const load_tag = 'opendxp.datahub.data_importer.resolver.load';

    const location_tag = 'opendxp.datahub.data_importer.resolver.location';

    const publish_tag = 'opendxp.datahub.data_importer.resolver.publish';

    const factory_tag = 'opendxp.datahub.data_importer.resolver.factory';
