...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.importPreview');
opendxp.plugin.opendxpDataImporterBundle.configuration.components.importPreview = Class.create({
    ...
    buildImportPreviewPanel: function() {
        ...
        if(!this.panel) {
            this.panel = Ext.create('Ext.Panel', {
                title: t('plugin_opendxp_datahub_data_importer_configpanel_import_preview'),
                region: 'west',
                autoScroll: true,
                animate: false,
                ...
                items: [
                    {
                        ...
                        tooltip: t('plugin_opendxp_datahub_data_importer_configpanel_preview_data_upload'),
                        handler: this.uploadDialog.bind(this)
                    },{
                        xtype: 'button',
                        iconCls: 'opendxp_icon_clone',
                        tooltip: t('plugin_opendxp_datahub_data_importer_configpanel_preview_data_clone'),
    ...
    buildPreviewGrid: function() {
        var columns = [
            {
                text: t('plugin_opendxp_datahub_data_importer_configpanel_preview_dataindex'),
                flex: 200,
                sortable: false,
                hidden: true,
                dataIndex: 'dataindex'
            ...
            {
                text: t('plugin_opendxp_datahub_data_importer_configpanel_preview_label'),
                flex: 130,
                sortable: false,
                dataIndex: 'label'
            },
            {
                text: t('plugin_opendxp_datahub_data_importer_configpanel_preview_data'),
                flex: 150,
                sortable: false,
                dataIndex: 'data',
        ...
        this.gridPanel = Ext.create('Ext.grid.Panel', {
            ...
            emptyText: t('plugin_opendxp_datahub_data_importer_configpanel_preview_empty'),
            tbar: {
                items: [
                    {
                        xtype: 'button',
                    ...
                    '->',
                    {
                        ...
                        xtype: 'button',
                        iconCls: 'plugin_opendxp_datahub_icon_previous',
                        handler: this.updatePreview.bind(this, 'previous', false)
                    },
                    {
                        xtype: 'button',
                        iconCls: 'plugin_opendxp_datahub_icon_next',
    ...
    checkValidConfiguration: function(suppressInvalidError) {
        ...
        if(!isValid) {
            if(!suppressInvalidError) {
                opendxp.helpers.showNotification(t('error'), t('plugin_opendxp_datahub_data_importer_configpanel_invalid_config_for_preview'), 'error');
            }
            return false;
        }
        return true;
