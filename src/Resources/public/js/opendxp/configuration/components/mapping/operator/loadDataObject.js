...
opendxp.registerNS("opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.operator.loadDataObject");
opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.operator.loadDataObject = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.abstractOperator, {
    ...
    getFormItems: function() {
        ...
        const partialMatch = Ext.create('Ext.form.field.Checkbox', {
            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_accept_partial_match'),
        ...
        const loadUnpublished = Ext.create('Ext.form.field.Checkbox', {
            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_dataobject_load_unpublished'),
        ...
        return [
            {
                xtype: 'combo',
                fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_dataobject_load_strategy'),
