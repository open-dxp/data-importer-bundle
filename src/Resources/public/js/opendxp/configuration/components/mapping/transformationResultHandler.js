...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.transformationResultHandler');
opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.transformationResultHandler = Class.create({
