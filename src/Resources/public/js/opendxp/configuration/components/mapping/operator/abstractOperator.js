...
opendxp.registerNS("opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.abstractOperator");
opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.abstractOperator = Class.create({

    type: 'abstract',
    menuGroup: '',
    menuGroups: {
        dataTypes: {
            text: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_data_types'),
            icon: "opendxp_icon_reload"
        },
        loadImport: {
            text: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_load_import'),
            icon: "opendxp_icon_import"
        },
        dataManipulation: {
            text: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_data_manipulation'),
    ...
    buildTransformationPipelineItem: function() {
        ...
        if(!this.form) {
            this.form = Ext.create('DataHub.DataImporter.StructuredValueForm', {
                ...
                tbar: this.getTopBar(t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_' + this.type), myId, this.container),
