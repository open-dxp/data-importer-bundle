...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.mappingConfiguration');
opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.mappingConfiguration = Class.create({
                    ...
                    items: [
                        {
                            ...
                            text: t('plugin_opendxp_datahub_data_importer_configpanel_mapping_collapse_all'),
                            iconCls: 'plugin_opendxp_datahub_icon_collapse',
                            handler: this.collapseAll.bind(this)
                        }, {
                            text: t('plugin_opendxp_datahub_data_importer_configpanel_mapping_autofill'),
                            iconCls: 'plugin_opendxp_datahub_icon_wizard',
                            handler: function() {
    ...
    addItem: function(mappingItemData, collapsed, scrollToBottom) {
        const mappingConfigurationItem = new opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.mappingConfigurationItem(mappingItemData, this.configItemRootContainer, this.transformationResultHandler);
