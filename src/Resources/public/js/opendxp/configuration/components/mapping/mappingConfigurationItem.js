...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.mappingConfigurationItem');
opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.mappingConfigurationItem = Class.create({
    ...
    buildMappingConfigurationItem: function () {
        ...
        if (!this.form) {
            this.form = Ext.create('DataHub.DataImporter.StructuredValueForm', {
                ...
                tools: [{
                    type: 'close',
                    cls: 'plugin_opendxp_datahub_icon_mapping_remove',
            ...
            this.transformationResultType = Ext.create('Ext.form.TextField', {
                ...
                listeners: {
                    change: function (field, newValue, oldValue) {
                        ...
                        this.form.fireEvent(
                            opendxp.plugin.opendxpDataImporterBundle.configuration.events.transformationResultTypeChanged,
                            newValue
                        );
                    }.bind(this)
                }
            ...
            this.configItemRootContainer.on(
                opendxp.plugin.opendxpDataImporterBundle.configuration.events.transformationResultPreviewUpdated,
            ...
            this.form.add([
                {
                    xtype: 'textfield',
                    fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_mapping_label'),
                    name: 'label',
                    value: data.label,
                    listeners: {
                        change: function (field, newValue, oldValue) {
                    ...
                    fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_mapping_source'),
                ...
                this.transformationResultType,
                {
                    ...
                    items: [{
                        ...
                        xtype: 'fieldcontainer',
                        fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_result_preview'),
                        layout: 'hbox',
                        items: [
                ...
                {
                    xtype: 'fieldset',
                    title: t('plugin_opendxp_datahub_data_importer_configpanel_data_target'),
                    defaults: {
                        labelWidth: 120,
                        width: 500
                    },
                    items: [
                        {
                            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_data_target_type'),
                            xtype: 'subsettingscombo',
                            name: 'dataTarget.type',
                            settingsNamePrefix: 'dataTarget.settings',
                            optionsNamespace: opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.datatarget,
    ...
    buildTransformationPipeline: function (data) {
        ...
        for (let i = 0; i < itemTypes.length; i++) {
            const menuGroup = opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.operator[itemTypes[i]].prototype.getMenuGroup();
            const iconClass = opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.operator[itemTypes[i]].prototype.getIconClass();
            if (menuGroup) {
    ...
    addTransformationPipelineItem: function (type, data, container) {
        const item = new opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.operator[type](
