...
opendxp.registerNS("opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.datatarget.manyToManyRelation");
opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.datatarget.manyToManyRelation = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {
    ...
    buildSettingsForm: function () {
        ...
        if (!this.form) {
            ...
            const errorField = Ext.create('Ext.form.Label', {
                html: '<p>' + t('plugin_opendxp_datahub_data_importer_configpanel_mtm_relation_type_error') + '</p>',
                style: 'color: #cf4c35'
            });

            const errorFieldExtMessage = Ext.create('Ext.form.Label', {
                html: t('plugin_opendxp_datahub_data_importer_configpanel_mtm_relation_type'),
            ...
            const overwriteMode = Ext.create('Ext.form.ComboBox', {
                fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_manyToManyRelation_write_settings_overwriteMode'),
                name: this.dataNamePrefix + 'overwriteMode',
                value: this.data.overwriteMode || 'replace',
                store: [
                    ['replace', t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_manyToManyRelation_write_settings_overwriteMode_replace')],
                    ['merge', t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_manyToManyRelation_write_settings_overwriteMode_merge')],
                ],
            ...
            const writeIfTargetIsNotEmpty = Ext.create('Ext.form.Checkbox', {
                boxLabel: t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_manyToManyRelation_write_settings_ifTargetIsNotEmpty'),
            ...
            const writeIfSourceIsEmpty = Ext.create('Ext.form.Checkbox', {
                boxLabel: t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_manyToManyRelation_write_settings_ifSourceIsEmpty'),
            ...
            const fieldContainerCB = Ext.create('Ext.form.FieldContainer',{
                fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_manyToManyRelation_write_settings_label'),
