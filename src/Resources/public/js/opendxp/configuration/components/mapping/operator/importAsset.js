...
opendxp.registerNS("opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.operator.importAsset");
opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.operator.importAsset = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.abstractOperator, {
    ...
    getFormItems: function() {
        ...
        let composite = Ext.create('Ext.form.FieldContainer', {
            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_target_folder'),
            layout: 'hbox',
            items: [
                this.parentFolder,
                {
        ...
        return [
            ...
            {
                xtype: 'checkbox',
                fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_use_existing'),
                value: this.data.settings ? this.data.settings.useExisting : true,
                name: 'settings.useExisting'
            },
            {
                xtype: 'checkbox',
                fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_overwrite_existing'),
                value: this.data.settings ? this.data.settings.overwriteExisting : true,
                name: 'settings.overwriteExisting'
            },
            {
                xtype: 'textfield',
                fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_transformation_pipeline_preg_match'),
