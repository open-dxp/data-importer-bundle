...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.datatarget.classificationstore');

opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.datatarget.classificationstore = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {
    ...
    buildSettingsForm: function() {
        ...
        if(!this.form) {
            ...
            const clsKeySelection = Ext.create('Ext.form.FieldContainer', {
                fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_classification_store_key'),
                layout: 'hbox',
                items: [
                    this.clsKeySelectionLabel,
                    {
                        ...
                        handler: function() {
                            ...
                            let searchWindow = new opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.tools.classificationStoreKeySearchWindow(
    ...
    updateDataKeyLabel: function(groupName, keyName) {
        this.clsKeySelectionLabel.setValue(keyName + ' ' + t('plugin_opendxp_datahub_data_importer_configpanel_classification_key_in_group') + ' ' + groupName);
    }
