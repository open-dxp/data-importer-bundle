...
opendxp.registerNS("opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.datatarget.direct");
opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.datatarget.direct = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {
    ...
    buildSettingsForm: function () {
        ...
        if (!this.form) {
            ...
            const writeIfTargetIsNotEmpty = Ext.create('Ext.form.Checkbox', {
                boxLabel: t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_direct_write_settings_ifTargetIsNotEmpty'),
            ...
            const writeIfSourceIsEmpty = Ext.create('Ext.form.Checkbox', {
                boxLabel: t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_direct_write_settings_ifSourceIsEmpty'),
            ...
            this.form = Ext.create('DataHub.DataImporter.StructuredValueForm', {
                ...
                items: [
                    ...
                    languageSelection,
                    {
                        ...
                        fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_dataTarget.type_direct_write_settings_label'),
