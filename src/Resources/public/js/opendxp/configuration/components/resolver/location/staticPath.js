...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.location.staticPath');
opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.location.staticPath = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {
