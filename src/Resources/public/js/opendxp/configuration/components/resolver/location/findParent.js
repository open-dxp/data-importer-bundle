...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.location.findParent');
opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.location.findParent = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {
        ...
        if(!this.form) {
            ...
            this.form = Ext.create('DataHub.DataImporter.StructuredValueForm', {
                ...
                items: [
                    ...
                    {
                        xtype: 'checkbox',
                        fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_as_variant'),
