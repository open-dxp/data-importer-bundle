...
opendxp.registerNS("opendxp.plugin.opendxpDataImporterBundle.configuration.components.loader.upload");
opendxp.plugin.opendxpDataImporterBundle.configuration.components.loader.upload = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {
