...
opendxp.registerNS("opendxp.plugin.opendxpDataImporterBundle.configuration.components.loader.asset");
opendxp.plugin.opendxpDataImporterBundle.configuration.components.loader.asset = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {
