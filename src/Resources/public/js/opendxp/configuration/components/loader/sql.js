...
opendxp.registerNS("opendxp.plugin.opendxpDataImporterBundle.configuration.components.loader.sql");
opendxp.plugin.opendxpDataImporterBundle.configuration.components.loader.sql = Class.create(opendxp.plugin.opendxpDataImporterBundle.configuration.components.abstractOptionType, {
        ...
        if(!this.form) {
            ...
            this.form = Ext.create('DataHub.DataImporter.StructuredValueForm', {
                ...
                items: [
                    {
                        xtype: 'combobox',
                        fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_sql_connection'),
