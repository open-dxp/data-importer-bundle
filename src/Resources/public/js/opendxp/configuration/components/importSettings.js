...
opendxp.registerNS('opendxp.plugin.opendxpDataImporterBundle.configuration.components.importSettings');
opendxp.plugin.opendxpDataImporterBundle.configuration.components.importSettings = Class.create({
    ...
    buildResolverTab: function() {
        ...
        this.resolverForm = Ext.create('DataHub.DataImporter.StructuredValueForm', {
            ...
            scrollable: true,
            title: t('plugin_opendxp_datahub_data_importer_configpanel_resolver'),
            items: [
                {
                    xtype: 'textfield',
                    name: 'elementType',
                    ...
                    listeners: {
                        change: function(combo, newValue, oldValue) {
                            ...
                            this.configItemRootContainer.fireEvent(
                                opendxp.plugin.opendxpDataImporterBundle.configuration.events.classChanged,
                                combo,
                                newValue,
                                oldValue
                            );
                        ...
                        added: function(combo) {
                            this.configItemRootContainer.fireEvent(
                                opendxp.plugin.opendxpDataImporterBundle.configuration.events.classInit,
                                combo,
                                combo.getValue(),
                            );
                        }.bind(this)
                ...
                {
                    xtype: 'fieldset',
                    title: t('plugin_opendxp_datahub_data_importer_configpanel_element_loading'),
                    defaults: panelDefaults,
                    width: 850,
                    items: [
                        {
                            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_loading_strategy'),
                            xtype: 'subsettingscombo',
                            name: 'loadingStrategy.type',
                            settingsNamePrefix: 'loadingStrategy.settings',
                            optionsNamespace: opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.load,
                ...
                },
                {
                    xtype: 'fieldset',
                    width: 850,
                    title: t('plugin_opendxp_datahub_data_importer_configpanel_element_creation'),
                    defaults: panelDefaults,
                    items: [
                        {
                            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_create_location_strategy'),
                            xtype: 'subsettingscombo',
                            name: 'createLocationStrategy.type',
                            settingsNamePrefix: 'createLocationStrategy.settings',
                            optionsNamespace: opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.location,
                ...
                },
                {
                    xtype: 'fieldset',
                    width: 850,
                    title: t('plugin_opendxp_datahub_data_importer_configpanel_element_location_update'),
                    defaults: panelDefaults,
                    items: [
                        {
                            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_update_location_strategy'),
                            xtype: 'subsettingscombo',
                ...
                },
                {
                    xtype: 'fieldset',
                    width: 850,
                    title: t('plugin_opendxp_datahub_data_importer_configpanel_element_publishing'),
                    defaults: panelDefaults,
                    items: [
                        {
                            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_publish_strategy'),
                            xtype: 'subsettingscombo',
                            name: 'publishingStrategy.type',
                            settingsNamePrefix: 'publishingStrategy.settings',
                            optionsNamespace: opendxp.plugin.opendxpDataImporterBundle.configuration.components.resolver.publish,
    ...
    buildProcessingTab: function() {
        ...
        const doDeltaCheckCheckbox = Ext.create('Ext.form.field.Checkbox', {
            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_delta_check'),
            name: 'doDeltaCheck',
        ...
        const doCleanup = Ext.create('Ext.form.field.Checkbox', {
            fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_do_cleanup'),
        ...
        const cleanupStrategy = Ext.create('DataHub.DataImporter.SubSettingsComboBox', {
            ...
            disabled: !this.processingConfigData.idDataIndex || 0 === this.processingConfigData.idDataIndex.length,
            optionsNamespace: opendxp.plugin.opendxpDataImporterBundle.configuration.components.cleanup,
        ...
        this.processingForm = Ext.create('DataHub.DataImporter.StructuredValueForm', {
            ...
            defaults: panelDefaults,
            scrollable: true,
            title: t('plugin_opendxp_datahub_data_importer_configpanel_processing_settings'),
            items: [
                {
                    xtype: 'combo',
                    name: 'executionType',
                    fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_execution_type'),
                    store: [
                        ['sequential', t('plugin_opendxp_datahub_data_importer_configpanel_execution_type_sequential')],
                        ['parallel', t('plugin_opendxp_datahub_data_importer_configpanel_execution_type_parallel')]
                    ],
                ...
                {
                    xtype: 'checkbox',
                    fieldLabel: t('plugin_opendxp_datahub_data_importer_configpanel_archive_import_file'),
    ...
    buildMappingsTab: function() {
        ...
        this.mappingConfiguration = new opendxp.plugin.opendxpDataImporterBundle.configuration.components.mapping.mappingConfiguration(
        ...
        const panel = Ext.create('Ext.Panel', {
            title: t('plugin_opendxp_datahub_data_importer_configpanel_mappings'),
            scrollable: false,
            layout: 'fit',
            items: [
