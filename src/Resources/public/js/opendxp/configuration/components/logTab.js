...
opendxp.plugin.opendxpDataImporterBundle.configuration.components.logTab = Class.create(baseClass, {
    ...
    getTabPanel: function($super) {
        ...
        this.panel.setTitle(t('plugin_opendxp_datahub_data_importer_configpanel_logs'));
